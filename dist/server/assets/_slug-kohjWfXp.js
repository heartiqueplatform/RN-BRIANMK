import { v as getDefaultExportFromCjs, I as jsxRuntimeExports } from "./server-D6PlxVzG.js";
import { h as createLucideIcon, e as Route, L as Link } from "./router-KkAtt7BH.js";
...
function PostDetail() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-32 pb-20 max-w-3xl mx-auto px-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/blog", className: "inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-primary mb-10 transition-colors group", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-xs mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-primary uppercase tracking-wider bg-primary/10 px-2 py-1 rounded", children: post2.category }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground inline-flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-3 w-3" }),
            " ",
            post2.read_time
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: post2.post_date })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-6xl font-display font-semibold leading-[1.1] tracking-tight text-balance", children: post2.title })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "prose prose-invert prose-lg max-w-none prose-headings:font-display prose-p:leading-relaxed prose-p:text-muted-foreground prose-strong:text-foreground prose-a:text-primary", children: post2.content ? /* @__PURE__ */ jsxRuntimeExports.jsx(Markdown, { children: post2.content.replace(/\\n/g, "\n") }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-muted-foreground italic", children: post2.excerpt }) })
    ] })
  ] });
}
export {
